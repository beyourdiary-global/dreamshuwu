<form method="POST" enctype="multipart/form-data" id="webSettingsForm">
    ...
    <div class="mb-4 row">
        ...
        <div class="col-md-9">
            <input type="text" name="website_name" class="form-control" value="<?php echo htmlspecialchars($current['website_name'] ?? ''); ?>">
        </div>
    </div>
        ...
        <div class="col-md-6">
            <div class="mb-4 row">
                ...
                <div class="col-md-6 d-flex align-items-center">
                    <input type="color" name="theme_bg_color" class="form-control form-control-color" value="<?php echo htmlspecialchars($current['theme_bg_color'] ?? '#ffffff'); ?>" title="Choose color">
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="mb-4 row">
                ...
                <div class="col-md-6 d-flex align-items-center">
                    <input type="color" name="theme_text_color" class="form-control form-control-color" value="<?php echo htmlspecialchars($current['theme_text_color'] ?? '#333333'); ?>" title="Choose color">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="mb-4 row">
                ...
                <div class="col-md-6 d-flex align-items-center">
                    <input type="color" name="button_color" class="form-control form-control-color" value="<?php echo htmlspecialchars($current['button_color'] ?? '#233dd2'); ?>" title="Choose color">
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="mb-4 row">
                ...
                <div class="col-md-6 d-flex align-items-center">
                    <input type="color" name="button_text_color" class="form-control form-control-color" value="<?php echo htmlspecialchars($current['button_text_color'] ?? '#ffffff'); ?>" title="Choose color">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mb-4 row">
        ...
        <div class="col-md-3 d-flex align-items-center">
            <input type="color" name="background_color" class="form-control form-control-color" value="<?php echo htmlspecialchars($current['background_color'] ?? '#f4f7f6'); ?>" title="Choose color">
        </div>
    </div>
